...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('images/don.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" action="signup.php" method="post" name="form-contact">
...
if(isset($_POST['submit'])){
	...
	$query="Insert into user(Name,email,username,Password,Mobile) values ('$name','$email','$date','$pass','$mobile')";
